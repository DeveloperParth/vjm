...
const ugSchema = joi
  .object({
    ...
    // parents
    father_name: joi.string().min(1).max(255).required(),
    mother_name: joi.string().min(1).max(255).required(),
    ...
    hsc_attempt: joi.number().integer().min(1).required(),
    hsc_total: joi.number().integer().min(1).max(1000).required(),
    hsc_obtained: joi.number().integer().min(1).max(1000).required(),
    hsc_percentage: joi.number().min(1).max(100).required(),
    hsc_percentile: joi.number().min(1).max(100).required(),
    hsc_grade: joi.string().min(1).max(255).required(),
    hsc_board: joi.string().min(1).max(255).required(),
    hsc_center: joi.string().min(1).max(255).required(),
    hsc_school_name: joi.string().min(1).max(255).required(),
    hsc_school_number: joi.string().min(1).max(255).required(),
    // other
    ...
    religion: joi.string().min(1).max(255).required(),
    caste: joi.string().min(1).max(255).required(),
    aadhar_number: joi.string().min(1).max(255).required(),
